    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-our-manuscript-titled-enhanced-quantum-cryptography-with-single-particle-state-rotation-has-been-published-in-the-springer-nature-journal-sn-computer-science",
          title: 'Our manuscript titled “Enhanced Quantum Cryptography with Single Particle State Rotation” has been...',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%72%61%73%65%6C%72%69%74%75%6E@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=qr4FDowAAAAJ", "_blank");
        },
      },{
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://circuitlab.ai", "_blank");
        },
      },{
      id: 'light-theme',
